...
class TeleopPublisher(Node):
    ...
    def on_release(self, key):
        if key in [
            ...
            keyboard.KeyCode.from_char('s'), keyboard.KeyCode.from_char('S')
        ]:
            self.twist.linear.x = 0.0
        elif key in [
            keyboard.KeyCode.from_char('a'), keyboard.KeyCode.from_char('A'),
            keyboard.KeyCode.from_char('d'), keyboard.KeyCode.from_char('D')
        ]:
